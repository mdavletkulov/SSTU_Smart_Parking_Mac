...
values (N'Главный бухгалтер', 'AUP'),
       (N'Начальник сектора виртуальных технологий ЦИТ и ДО', 'AUP'),
...
values (null, 1, N'Елена', N'Анисимова', N'Станиславовна', null, DATEADD(month, 6, current_timestamp), 15, 0, 0, (select id from job_position where name_position = N'Главный бухгалтер'), null, null),
       ...
       (null, 1, N'Михаил', N'Королев', N'Сергеевич', null, DATEADD(month, 4, current_timestamp), 8, 0, 0, (select id from job_position where name_position = N'Начальник сектора виртуальных технологий ЦИТ и ДО'), null, null),
...
values ('Lada Calina', 'T314PO64', 4, (select id from person where second_name = N'Анисимова')),
